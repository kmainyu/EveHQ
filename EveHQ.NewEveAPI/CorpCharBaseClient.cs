...
namespace EveHQ.EveApi
{
    ...
    public abstract class CorpCharBaseClient : BaseApiClient
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="CorpCharBaseClient"/> class. Initializes a new instance of the CharacterClient class.</summary>
        ...
        public Task<EveServiceResponse<IEnumerable<AccountBalance>>> AccountBalanceAsync(string keyId, string vCode, int characterId)
        {
        ...
        public Task<EveServiceResponse<IEnumerable<AssetItem>>> AssetListAsync(string keyId, string vCode, int characterId)
        {
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixHourCache, ParseAssetListResponse);
        }
        ...
        public Task<EveServiceResponse<IEnumerable<ContactList>>> ContactList(string keyId, string vCode, int characterId)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ParseContactListResponse);
        }
        ...
        public Task<EveServiceResponse<IEnumerable<ContactNotification>>> ContactNotifications(string keyId, string vCode, int characterId)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ParseContactNotificationResponse);
        }
        ...
        public Task<EveServiceResponse<IEnumerable<Contract>>> Contracts(string keyId, string vCode, int characterId, int contractId = 0)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), apiParams, cacheKey, ApiConstants.SixtyMinuteCache, ParseContractResponse);
        }
        ...
        /// <returns>The <see cref="Task"/>.</returns>
        public Task<EveServiceResponse<IEnumerable<ContractItem>>> ContractItems(string keyId, string vCode, int characterId, int contractId)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), apiParams, cacheKey, ApiConstants.SixtyMinuteCache, ParseContractItemResponse);
        }
        ...
        public Task<EveServiceResponse<IEnumerable<ContractBid>>> ContractBids(string keyId, string vCode, int characterId)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ProcessContractBidsResponse);
        }
        ...
        /// <param name="characterId">Character to query.</param>
        /// <returns>Factional warfare data.</returns>
        public Task<EveServiceResponse<FactionalWarfareStats>> FactionalWarfareStatistics(string keyId, string vCode, int characterId)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ParseFacWarfareResponse);
        }
        ...
        public Task<EveServiceResponse<IEnumerable<IndustryJob>>> IndustryJobs(string keyId, string vCode, int characterId)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
        ...
        public Task<EveServiceResponse<IEnumerable<MarketOrder>>> MarketOrdersAsync(string keyId, string vCode, int characterId)
        {
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ProcessMarketOrdersResponse);
        }
        ...
        public Task<EveServiceResponse<IEnumerable<Medal>>> Medals(string keyId, string vCode, int characterId)
        {
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ProcessMedalsResponse);
        }
        ...
        public Task<EveServiceResponse<IEnumerable<Research>>> Research(string keyId, string vCode, int characterId)
        {
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ProcessResearchResponse);
        }
        ...
        public Task<EveServiceResponse<SkillInTraining>> SkillInTraining(string keyId, string vCode, int characterId)
        {
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ProcessSkillInTrainingResponse);
        }
        ...
        public Task<EveServiceResponse<IEnumerable<QueuedSkill>>> SkillQueue(string keyId, string vCode, int characterId)
        {
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ProcessSkillQueueResponse);
        }
        ...
        /// <param name="characterId">The character id.</param>
        /// <returns>The <see cref="Task"/>.</returns>
        public Task<EveServiceResponse<IEnumerable<NpcStanding>>> NPCStandings(string keyId, string vCode, int characterId)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), null, cacheKey, ApiConstants.SixtyMinuteCache, ProcessStandingsResponse);
        }
        ...
        /// <returns>The <see cref="Task"/>.</returns>
        public Task<EveServiceResponse<IEnumerable<WalletJournalEntry>>> WalletJournal(string keyId, string vCode, int characterId, long? fromId = null, int? rowCount = null)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), apiParams, cacheKey, ApiConstants.SixtyMinuteCache, ProcessWalletJournalResponse);
        }
        ...
        /// <param name="rowCount">The row count.</param>
        /// <returns>The <see cref="Task"/>.</returns>
        public Task<EveServiceResponse<IEnumerable<WalletTransaction>>> WalletTransactions(string keyId, string vCode, int characterId, long? fromId = null, int? rowCount = null)
        {
            System.Diagnostics.Contracts.Contract.Requires(!keyId.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(!vCode.IsNullOrWhiteSpace());
            System.Diagnostics.Contracts.Contract.Requires(characterId > 0);
            ...
            return this.GetServiceResponseAsync(keyId, vCode, characterId, MethodPath.FormatInvariant(this.PathPrefix), apiParams, cacheKey, ApiConstants.SixtyMinuteCache, ProcessWalletTransctionResponse);
        }
        ...
        private static IEnumerable<IndustryJob> ParseIndustryJobsResponse(XElement result)
        {
            ...
            IEnumerable<IndustryJob> jobs = (from rowset in result.Elements(ApiConstants.Rowset)
                                             from row in rowset.Elements(ApiConstants.Row)
                                             let jobId = row.Attribute("jobID").Value.ToInt32()
                                             let assemblyLineId = row.Attribute("assemblyLineID").Value.ToInt32()
                                             let containerId = row.Attribute("containerID").Value.ToInt32()
                                             let installedItemId = row.Attribute("installedItemID").Value.ToInt32()
                                             let installedItemLocationId = row.Attribute("installedItemLocationID").Value.ToInt32()
                                             ...
                                             let containerLocationId = row.Attribute("containerLocationID").Value.ToInt32()
                                             ...
                                             let containerTypeId = row.Attribute("containerTypeID").Value.ToInt32()
        ...
        private static IEnumerable<ContactList> ParseContactListResponse(XElement result)
        {
            if (result == null)
            {
                return new ContactList[0]; // return empty collection... no data.
            }
        ...
        private static AssetItem CreateItemFromRow(XElement row, int parentId)
        {
            ...
            return new AssetItem { ItemId = itemId, LocationId = locationId, TypeId = typeId, Quantity = quantity, Flag = flag, Singleton = single, Contents = children, ParentItemId = parentId };
        }
    }
}