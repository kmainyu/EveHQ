...
Public Class frmUpgradeMDB
    ...
    Private Sub frmUpgradeMDB_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For Each param As String In System.Environment.GetCommandLineArgs
            EveHQ.Core.HQ.appDataFolder = param
        Next

        ' Load Settings
        Call Me.LoadEveHQSettings()
    ...
    Private Function LoadEveHQSettings() As Boolean
    ...
    Private Sub CompareWorker_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles FormWorker.RunWorkerCompleted
        MessageBox.Show("The upgrade process has been completed. Press OK to close the application and confirm with EveHQ that the upgrade has completed.", "Upgrade Complete", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Me.Close()
    End Sub
...
#Region "Table Conversion Routines"
    ...
    Private Sub ConvertAssetItemNamesTable(ByVal OldMDB As String)
    ...
    Private Sub ConvertCustomPricesTable(ByVal OldMDB As String)
    ...
    Private Sub ConvertEveIDToNameTable(ByVal OldMDB As String)
    ...
    Private Sub ConvertEveMailTable(ByVal OldMDB As String)
    ...
    Private Sub ConvertEveNotificationsTable(ByVal OldMDB As String)
    ...
    Private Sub ConvertMarketPricesTable(ByVal OldMDB As String)
