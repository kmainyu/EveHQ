...
#Region "Protected variables"
        ...
        Protected sBrowsableText As String = ""
...
#Region "Private methods"
        ...
        Private Sub BuildAttributes_FilenameEditor()
            ...
            attrArray = CType(attrs.ToArray(GetType(Attribute)), Attribute())
        ...
        Private Sub BuildAttributes_BrowsableProperty()
            ...
            Dim text As New BrowsableTypeConverter.BrowsableLabelTextAttribute(CStr(sBrowsableText))
                ...
                If oRow.RowState <> DataRowState.Deleted Then
                    ...
                    Else
                        ...
                        If oLookupTable IsNot Nothing Then
                            Return oLookupTable.Select(sValueMember & "=" & oRow(sProp).ToString)(0).Item(sDisplayMember)
                        Else
                    ...
                    Else
                        ...
                        If oLookupTable IsNot Nothing Then
                            If oLookupTable.Columns(sDisplayMember).DataType.Equals(System.Type.GetType("System.String")) Then
                                oRow(sProp) = oLookupTable.Select(oLookupTable.Columns(sDisplayMember).ColumnName & " = '" & value.ToString & "'")(0).Item(sValueMember)
                            Else
                                oRow(sProp) = oLookupTable.Select(oLookupTable.Columns(sDisplayMember).ColumnName & " = " & value.ToString)(0).Item(sValueMember)
                            End If
                        Else
...
#Region "CustomPropertyDescriptor"
        Public Class CustomPropertyDescriptor
            ...
            Public ReadOnly Property CustomProperty() As Object
                Get
