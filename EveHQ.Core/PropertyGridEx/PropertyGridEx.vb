...
#Region "Public Functions"
        Public Sub New()
            ...
            oToolStrip = CType(MyBase.GetType.BaseType.InvokeMember("toolStrip", BindingFlags.NonPublic Or BindingFlags.GetField Or BindingFlags.Instance, Nothing, Me, Nothing), Windows.Forms.ToolStrip)
            ...
            If oDocComment IsNot Nothing Then
                oDocCommentTitle = CType(oDocComment.GetType.InvokeMember("m_labelTitle", BindingFlags.NonPublic Or BindingFlags.GetField Or BindingFlags.Instance, Nothing, oDocComment, Nothing), Label)
                oDocCommentDescription = CType(oDocComment.GetType.InvokeMember("m_labelDesc", BindingFlags.NonPublic Or BindingFlags.GetField Or BindingFlags.Instance, Nothing, oDocComment, Nothing), Label)
            End If
        ...
        Public Overrides Sub Refresh()
            If bShowCustomPropertiesSet Then
                MyBase.SelectedObjects = CType(oCustomPropertyCollectionSet.ToArray, Object())
            End If            
            MyBase.Refresh()
        ...
        Public Sub SetComment(ByVal title As String, ByVal description As String)
            Me.SetComment(title, description)
        End Sub
...
#Region "Protected Functions"
        ...
        Protected Sub AutoSizeSplitter(Optional ByVal RightMargin As Integer = 24)
            ...
            Dim oItemCollection As GridItemCollection = CType(oPropertyGridEntries.GetValue(oPropertyGridView), GridItemCollection)
            ...
            For Each oItem In oItemCollection
                ...
                If oItem.GridItemType = GridItemType.Property Then
                    CurWidth = CInt(oGraphics.MeasureString(oItem.Label, Me.Font).Width + RightMargin + (nested - 1))
...
#Region "Properties"
        ...
        Public ReadOnly Property DocComment() As Control
            Get
                Return CType(oDocComment, Control)
            End Get
        End Property
