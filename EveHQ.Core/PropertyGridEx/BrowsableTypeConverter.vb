...
Namespace PropertyGridEx
    Public Class BrowsableTypeConverter
        ...
        Public Overrides Function ConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object, ByVal destinationType As System.Type) As Object
            Dim Style As BrowsableLabelStyleAttribute = CType(context.PropertyDescriptor.Attributes(GetType(BrowsableLabelStyleAttribute)), BrowsableLabelStyleAttribute)
            If Not Style Is Nothing Then
                Select Case Style.LabelStyle
                    ...
                    Case LabelStyle.lsText
                        Dim text As BrowsableLabelTextAttribute = CType(context.PropertyDescriptor.Attributes(GetType(BrowsableLabelTextAttribute)), BrowsableLabelTextAttribute)
