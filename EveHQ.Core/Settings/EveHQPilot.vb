<Serializable()> Public Class EveHQPilot
    ...
    Public Property IAtt As Integer = 0
    ...
    Public Property IImplant As Integer = 0
    ...
    Public Property IImplantA As Integer = 0
    ...
    Public Property IImplantM As Integer = 0
    ...
    Public Property IAttT As Double = 0
