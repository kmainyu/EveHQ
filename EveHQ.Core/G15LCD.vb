...
'    Private connectContext As LgLcd.NET.LgLcd.lgLcdConnectContext = New LgLcd.NET.LgLcd.lgLcdConnectContext()
'    Private openContext As LgLcd.NET.LgLcd.lgLcdOpenContext = New LgLcd.NET.LgLcd.lgLcdOpenContext()

'    'The lgLcdBitmap160x43x1 used to represent the screen
'    Private LCDBitmap As LgLcd.NET.LgLcd.lgLcdBitmap160x43x1 = New LgLcd.NET.LgLcd.lgLcdBitmap160x43x1
...
'        connectContext.connection = LgLcd.NET.LgLcd.LGLCD_INVALID_CONNECTION
'        res = LgLcd.NET.LgLcd.lgLcdConnect(connectContext)
...
'        openContext.device = LgLcd.NET.LgLcd.LGLCD_INVALID_DEVICE
'        res = LgLcd.NET.LgLcd.lgLcdOpen(openContext)
'        LCDBitmap.hdr.Format = LgLcd.NET.LgLcd.LGLCD_BMP_FORMAT_160x43x1
...
'        LgLcd.NET.LgLcd.lgLcdUpdateBitmap(openContext.device, LCDBitmap, LgLcd.NET.LgLcd.LGLCD_PRIORITY_NORMAL)
'    End Sub
'    Public Sub UpdateLCD_Alert()
'        LgLcd.NET.LgLcd.lgLcdUpdateBitmap(openContext.device, LCDBitmap, LgLcd.NET.LgLcd.LGLCD_PRIORITY_ALERT)
'    End Sub

'    Public Sub CloseLCD()
'        Dim res As Integer
'        ' Close the LCD
'        res = LgLcd.NET.LgLcd.lgLcdClose(openContext.device)
'        HandleError(res, "lgLcdClose")
'        res = LgLcd.NET.LgLcd.lgLcdDisconnect(connectContext.connection)
'        HandleError(res, "lgLcdDisconnect failed")
'        res = LgLcd.NET.LgLcd.lgLcdDeInit()
