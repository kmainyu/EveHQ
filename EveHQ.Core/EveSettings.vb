...
<Serializable()> Public Class EveSettings
    ...
    Private cUpdateURL As String = "http://www.indiceve.com/evehq/updatev2/"
...
Public Class EveHQSettingsFunctions
    ...
    Public Shared Function LoadEveHQSettings() As Boolean
        ...
        If EveHQ.Core.HQ.EveHQSettings.UpdateURL <> "http://www.indiceve.com/evehq/updatev2/" Then
            EveHQ.Core.HQ.EveHQSettings.UpdateURL = "http://www.indiceve.com/evehq/updatev2/"
        End If
