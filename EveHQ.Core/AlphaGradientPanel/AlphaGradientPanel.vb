...
#Region "PROPERTIES"
    ...
    Private eImagePosition As ImagePosition = Core.ImagePosition.BottomRight
    <Category("Image")> _
...
#End Region
    ...
    Private Sub AlphaGradientPanel_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        ...
        If Not Image Is Nothing Then
            Dim btBitmap As Bitmap = CType(Image, Bitmap)
            ...
            Select Case ImagePosition
                Case Core.ImagePosition.TopLeft
                ...
                Case Core.ImagePosition.BottomRight
                ...
                Case Core.ImagePosition.TopRight
                ...
                Case Core.ImagePosition.BottomLeft
                ...
                Case Core.ImagePosition.Center
                    rcImage = New Rectangle(CInt(((rcContent.Width - ImageSize.Width) / 2) + ContentPadding.Left), CInt(((rcContent.Height - ImageSize.Height) / 2) + ContentPadding.Top), ImageSize.Width, ImageSize.Height)
            End Select
