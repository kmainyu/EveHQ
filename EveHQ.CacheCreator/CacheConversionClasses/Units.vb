...
Namespace CacheConversionClasses
    ...
    Public Class Units
        ...
        Friend Shared dataCollection As New List(Of Unit)
        Const tableName As String = "eveUnits"
        Const tableColumns As Integer = 4
        Const deleteSQL As String = "DELETE FROM " & tableName & ";"
        Const createSQL As String = "DROP TABLE IF EXISTS " & tableName & "; CREATE TABLE " & tableName & "(unitID int NOT NULL, unitName text NULL, displayName text NULL, description text NULL);"
        Const insertSQL As String = "INSERT INTO " & tableName & "(unitID, unitName, displayName, description) VALUES (?,?,?,?);"
                ...
                Try
                    ...
                    Using sqlCmd As SQLiteCommand = connection.CreateCommand
                        Using sqlTrans As SQLiteTransaction = connection.BeginTransaction
                            ...
                            For Each data As Unit In dataCollection

                                ' Add the database values and execute the query
                                sqlCmd.Parameters(0).Value = data.unitID
                                sqlCmd.Parameters(1).Value = data.unitName
                                sqlCmd.Parameters(2).Value = data.displayName
    ...
    ''' <summary>
    ''' Class to hold an instance of a Unit
    ''' </summary>
    ''' <remarks></remarks>
    Public Class Unit
