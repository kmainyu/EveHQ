...
Namespace CacheConversionClasses
    ...
    Public Class MetaGroups
        ...
        Friend Shared dataCollection As New List(Of MetaGroup)
        Const tableName As String = "invMetaGroups"
        Const tableColumns As Integer = 4
        Const deleteSQL As String = "DELETE FROM " & tableName & ";"
        Const createSQL As String = "DROP TABLE IF EXISTS " & tableName & "; CREATE TABLE " & tableName & "(metaGroupID int NOT NULL, metaGroupName text NULL, description text NULL, iconID int NULL, published boolean NULL);"
        Const insertSQL As String = "INSERT INTO " & tableName & "(metaGroupID, metaGroupName, description, iconID) VALUES (?,?,?,?);"
                ...
                Try
                    ...
                    Using sqlCmd As SQLiteCommand = connection.CreateCommand
                        Using sqlTrans As SQLiteTransaction = connection.BeginTransaction
                            ...
                            For Each data As MetaGroup In dataCollection

                                ' Add the database values and execute the query
                                sqlCmd.Parameters(0).Value = data.metaGroupID
                                sqlCmd.Parameters(1).Value = data.metaGroupName
    ...
    ''' <summary>
    ''' Class to hold an instance of a MetaGroup
    ''' </summary>
    ''' <remarks></remarks>
    Public Class MetaGroup
        Public Property metaGroupID As Integer
        Public Property metaGroupName As String
