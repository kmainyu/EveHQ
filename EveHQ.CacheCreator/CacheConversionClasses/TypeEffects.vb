...
Namespace CacheConversionClasses
    ...
    Public Class TypeEffects
        ...
        Friend Shared dataCollection As New List(Of TypeEffect)
        Const tableName As String = "dgmTypeEffects"
        Const tableColumns As Integer = 3
        Const deleteSQL As String = "DELETE FROM " & tableName & ";"
        Const createSQL As String = "DROP TABLE IF EXISTS " & tableName & "; CREATE TABLE " & tableName & "(typeID int NOT NULL,effectID int NOT NULL,isDefault boolean NULL);"
        Const insertSQL As String = "INSERT INTO " & tableName & "(typeID, effectID, isDefault) VALUES (?,?,?);"
                ...
                Try
                    ...
                    Using sqlCmd As SQLiteCommand = connection.CreateCommand
                        Using sqlTrans As SQLiteTransaction = connection.BeginTransaction
                            ...
                            For Each data As TypeEffect In dataCollection

                                ' Add the database values and execute the query
                                sqlCmd.Parameters(0).Value = data.typeID
                                sqlCmd.Parameters(1).Value = data.effectID
                                sqlCmd.Parameters(2).Value = data.isDefault
    ...
    ''' <summary>
    ''' Class to hold an instance of a TypeEffect
    ''' </summary>
    ''' <remarks></remarks>
