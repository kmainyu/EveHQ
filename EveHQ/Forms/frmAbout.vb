...
Public Class frmAbout
    ...
    Private Sub frmAbout_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        credits.Append("<tr><td>EveHQ Created By</td><td align='right'>Vessper</td></tr>")
        credits.Append("<tr><td>Current Lead Developer</td><td align='right'>Quantix Blackstar</td></tr>")
        credits.Append("<tr><td>Plug-in Development</td><td align='right'>Sherkhan</td></tr>")
        credits.Append("<tr><td colspan=2>Code Contributions:</td></tr>")
        credits.Append("<tr><td align='right' colspan=2>Arkan5, Darkwolf, Darmed Khan, Eowarian, farlin, geniusfreak, Mdram, Modescond, MoWe79, MrCue, Nauvus3x7, Saulvin, Taedrin, Thorien</td></tr>")
