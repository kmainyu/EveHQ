...
#Region "Export to Eve Routines"
    ...
    Private Sub ExportFittingsToEve()
        ...
        Call Me.ExportFittingsToEveFile(Fittings)
    End Sub
    ...
    Private Sub ExportFittingsToEveFile(ByVal fittingList As ArrayList)
        ...
        If fittingList.Count > 0 Then
            For Each shipFit As String In fittingList
                Dim fittingSep As Integer = shipFit.IndexOf(", ")
                Dim shipName As String = shipFit.Substring(0, fittingSep)
                Dim fittingName As String = shipFit.Substring(fittingSep + 2)
            ...
            Try
                If My.Computer.FileSystem.DirectoryExists(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\Eve\fittings") = False Then
                    My.Computer.FileSystem.CreateDirectory(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\Eve\fittings")
                End If
                fitXML.Save(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\Eve\fittings\HQFTest.xml")
                MessageBox.Show("Export of HQF Fittings to " & My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\Eve\fittings\HQFTest.xml completed", "Export Complete", MessageBoxButtons.OK, MessageBoxIcon.Information)
