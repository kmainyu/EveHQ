...
<Serializable()> Class HQFPilotCollection
    ...
    Public Shared Sub SaveHQFPilotData()
        Dim s As New FileStream(HQF.Settings.HQFFolder & "\HQFPilotSettings.txt", FileMode.Create)
    ...
    Public Shared Sub LoadHQFPilotData()
        If My.Computer.FileSystem.FileExists(HQF.Settings.HQFFolder & "\HQFPilotSettings.txt") = True Then
            Dim s As New FileStream(HQF.Settings.HQFFolder & "\HQFPilotSettings.txt", FileMode.Open)
