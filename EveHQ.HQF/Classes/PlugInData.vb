...
Public Class PlugInData
    ...
    Shared LastCacheRefresh As String = "1.11.1.597"
...
#Region "Plug-In Initialisation (Data Loading/Building) Routines"
    ...
    Private Function LoadModuleData() As Boolean
        Try
            ...
            strSQL &= " WHERE ((invCategories.categoryID In (7,8,18,20,32)) or (invTypes.marketGroupID=379)) AND (invTypes.published=1)"
